  ...
  return (
    <div className="broadcast-card rounded-lg p-4 flex flex-col gap-2">
      <div className="flex items-center justify-between">
        ...
        <span className="grid place-items-center w-7 h-7 rounded-lg" style={{ background: color+'22', color }}>
          ...
          <>
            <Section title="Users">
              <div className="grid grid-cols-2 gap-3 lg:grid-cols-5">
                <Stat label="Total"       value={data.users.total}       color="var(--text)"  icon="person" />
            ...
            <Section title="Matches">
              <div className="grid grid-cols-2 gap-3 lg:grid-cols-5">
                <Stat label="Total"     value={data.matches.total}     color="var(--text)"  icon="soccer" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="broadcast-card rounded-lg p-4">
                <h3 className="text-[11px] font-semibold uppercase tracking-[.06em] text-[color:var(--muted)] mb-3">Subscriptions</h3>
              ...
              <div className="broadcast-card rounded-lg p-4">
                          ...
                          content={({ active, payload, label }) =>
                            active && payload?.length ? (
                              <div className="bg-[color:var(--surface)] border border-[color:var(--border)] rounded px-2 py-1 text-[11px] text-[color:var(--text)]">
                                {/* ✅ FIX 2: Type-safe label handling for Recharts */}
                ...
                {revenue && (
                  <>
                    <InfoRow label="Pending (KES)" value={kes(revenue.pending_total)} color="var(--gold)" />
                    <InfoRow label="Pending count" value={revenue.pending_count} />
            ...
            <Section title="System">
              <div className="broadcast-card rounded-lg p-4">
                <div className="grid grid-cols-2 gap-3 lg:grid-cols-5">
                  ...
                  <Stat label="Failed jobs"      value={data.system.failed_jobs}      color={data.system.failed_jobs > 0 ? 'var(--red)' : 'var(--green)'} icon="error" />
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  ...
                  <a key={href} href={href}
                    ...
                    <span className="w-8 h-8 rounded-lg grid place-items-center shrink-0" style={{ background: color+'22', color }}>
